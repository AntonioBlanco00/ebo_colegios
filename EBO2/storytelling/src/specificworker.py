...
class SpecificWorker(GenericWorker):
    ...
    def startGame_clicked_conv(self):
        ...
        self.cerrar_ui(2)
        # SET GAME INFO
        self.gpt_proxy.setGameInfo("", self.user_info)
        self.lanzar_ui4()
    ...
    def setDatos(self):
        ...
        self.user_info = (f"Vas a hablar con {self.nombre_jugador}. Presentate diciendo que eres el robot mas guapete y simpático del mundo y diciendo que estás encantado de estar hoy aquí con ellxs.")
